Gem::Specification.new do |s|
  ...
  s.files = ["History.txt", "License.txt", "Manifest.txt", "README.txt", "Rakefile", "lib/leetspeak.rb", "lib/leetspeak/string.rb", "setup.rb", "test/test_helper.rb", "test/test_leetspeak.rb"]
  s.has_rdoc = true
  ...
  s.test_files = ["test/test_helper.rb", "test/test_leetspeak.rb"]
